...
public class ArrivalBoardListFragment extends ListFragment {
    ...
    public ArrayList<ArrivalBoard> getArrivalBoardsForSelectedStation() {
        //TODO: Phase 2 Task 8
        ArrayList<ArrivalBoard> arrivalBoardList = new ArrayList<ArrivalBoard> ();
        Station selectedStation = StationManager.getInstance().getSelected();
        Iterator arrivalBoards = selectedStation.iterator();

        while(arrivalBoards.hasNext()){

            Object arrivalBoard = arrivalBoards.next();
            arrivalBoardList.add((ArrivalBoard) arrivalBoard);
